...
Public Class uCPromedioGeneralesCarreras
    ...
    Public Sub onControlLoad() Handles MyBase.Load
        ...
        Me.rpvPromediosGeneralesCarreras.RefreshReport()
    ...
    Private Sub actualizarReportViewer()
        ...
        Me.pa_reporte_promedios_generales_de_carrerasTableAdapter.Fill(Me.beca_becademicDataSet.pa_reporte_promedios_generales_de_carreras, periodoInicial, anioInicial, periodoFinal, anioFinal)
